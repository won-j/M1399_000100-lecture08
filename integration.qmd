...
**Theorem 3**. Suppose functions $f$ and $g$ satisfy the following conditions
...
4. the integral $\int_{-\infty}^{\infty}f(x)e^{-ag(x)}dx$ is absolutely convergent for $a \ge a_0 > 0$.
Then, 
$$
    \int_{-\infty}^{\infty} f(x)e^{-a g(x)} dx
    \asymp
